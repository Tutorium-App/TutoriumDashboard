...
<div className="flex justify-end">
  ...
  >
    ...
    >
      ...
      <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-54 h-screen transition-transform ${
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-blue-600 dark:bg-gray-800">
          ...
          <ul className="space-y-7 pl-0 font-medium">
            <li>
              <a
                href="#"
                className={`flex items-center justify-center  p-2 border no-underline rounded-lg dark:text-white ${currentView === 'home' ? 'text-blue-700 border bg-white' : 'text-white hover:bg-blue-700 dark:hover:bg-gray-700 group'
                  }`}
            ...
            <li>
              <a
                href="#"
                className={`flex items-center justify-center p-2 border no-underline rounded-lg dark:text-white ${currentView === 'manageTutors' ? 'text-blue-700 border bg-white' : 'text-white hover:bg-blue-700 dark:hover:bg-gray-700 group'
                  }`}
