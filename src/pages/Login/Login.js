...
function Login() {
  return (
    ...
    <div className="">
  <div className="text-5xl font-semibold text-center text-blue-600 mt-37">Tutorium</div>
  <div className="flex items-center justify-center h-full m-2">
    <form className="max-w-sm p-4 mx-auto bg-blue-600 border rounded-xl w-100">
      <div className="mb-4">
        <label htmlFor="email" className="block mb-4 font-medium text-white text- dark:text-white">Admin Dashboard</label>
